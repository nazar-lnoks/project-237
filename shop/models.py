...
class Product(models.Model):
    ...
    averageRate = models.DecimalField(max_digits=1, decimal_places=1, verbose_name='Average rate', default=0.0)
...
class Feedback(models.Model):
    ...
    rate = models.DecimalField(max_digits=1, decimal_places=1, verbose_name='Rate')
